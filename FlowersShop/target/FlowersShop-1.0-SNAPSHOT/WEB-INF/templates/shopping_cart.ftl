            ...
            <form method="post" action="/shopping_cart">
                    ...
                    <table width="700" border="0" cellpadding="5" cellspacing="0">
                        ...
                        <#list items as f>
                            ...
                            <tr bgcolor="#41581B">
                                <td><img src="/images/product/${f.flower.img}.jpg" alt="flower" width="165"
                                         height="165"/></td>
                                <td>${f.flower.name}</td>
                                <td align="center">${f.quantity}</td>
                                <td align="right">${f.flower.price}</td>
                                <td align="right">${f.total}</td>
                                <td align="center">
                                    <#--<form action="/item_delete/${f.flower.id}" method="post">-->
