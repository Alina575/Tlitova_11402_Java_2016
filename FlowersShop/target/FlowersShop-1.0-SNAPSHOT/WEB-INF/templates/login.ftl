            ...
            <div id="content" class="right">
                ...
                <form id="loginform" action="/auth" method="post">
                    <div class="content_half left" align="right">
                        ...
                        <#if error??>
                            <h5 style="color: #ff0000">Неверный логин или пароль</h5>
                            <br/>
                        </#if>
                        ...
                        <div class='chb' align="left">
                            <input type='checkbox' name='remember-me-param' value="true"/>
                            <label for='chb1'><span></span>
                            <small class='small-text'>Запомнить меня</small></label></div>
                        <br/>
                        <div align="right"><input class="login" type="submit" value="Войти"/></div>
                    </div>
                </form>
