...
<div id="templatemo_wrapper_h">
    ...
    <div id="templatemo_main_wrapper">
        <div id="templatemo_main">
            ...
            <#if messages?has_content>
                <table width="700" border="0" cellpadding="5" cellspacing="0">
                    <tr bgcolor="#395015">
                        ...
                        <th width="60" align="center">Дата</th>
                    </tr>
                </table>
                ...
                <#list messages as m>
                    ...
                    <table width="700" border="0" cellpadding="5" cellspacing="0">
                        <tr bgcolor="#41581B">
                            <td width="80" align="center">${m.user.login}</td>
                            <td width="60" align="center">${m.phone}</td>
                            <td width="60" align="center">${m.date}</td>
                        </tr>
                    </table>
            ...
            <#else>
                <p>Ни одного сообщения не найдено!</p>
            </#if>
