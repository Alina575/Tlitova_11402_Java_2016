        ...
        <div id="templatemo_main">
            ...
            <#list flowers as f>
                <div class="product_box">
                    <a href="/product_detail/${f.id}">
                        <img src="../images/product/${f.img}.jpg" width="165" height="165"/>
                    </a>

                    <h3>${f.name} ${f.type}</h3>

                    <p class="product_price">${f.price} руб</p>


                    <#--<p class="add_to_cart">-->
                        <#--<a href="/product_detail/${f.id}">Детали</a>-->

                        <form action="/shopping_cart/${f.id}" method="post">
                        <#--<#if userCart?seq_contains('${f}')>-->
                            <#--<br/><h4 class="black">В корзине</h4>-->
                        <#--<#else>-->
