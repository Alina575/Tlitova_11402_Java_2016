    ...
    <div id="templatemo_main_wrapper">
        <div id="templatemo_main">
            ...
            <div id="content" class="right">
                ...
                <p>Cras aliquam, mi nec imperdiet volutpat, ligula est consequat odio, eu auctor urna augue eu quam.
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis bibendum nec nunc ac hendrerit. Morbi
                    lacinia placerat diam sit amet fringilla. Integer accumsan suscipit suscipit. Mauris non nunc sit
                    amet turpis pharetra mattis. Validate <a href="http://validator.w3.org/check?uri=referer"
            ...
            <#list flowers as f>
                <#assign url = "/products/all">

                <#assign product_detail = "/product_detail/" + f.id>
                <a href="${product_detail?j_string}">
                    <img src="../resources/images/${f.img}.jpg"/>
                </a>
                ...
                <p class="add_to_cart">
                    <a href="/product_detail">Детали</a>
                    <a href="/shopping_cart">В корзину</a>
                </p>
            </div>
            </#list>
                ...
                <div class="product_box">
                    <a href="product_detail.ftl"><img src="/rs/images/product/02.jpg" alt="flowers 2"/></a>
                    ...
                    <p class="add_to_cart">
                        <a href="product_detail.ftl">Детали</a>
                        <a href="shopping_cart.ftl">В корзину</a>
                    </p>
                </div>
                <div class="product_box">
                    <a href="product_detail.ftl"><img src="/rs/images/product/03.jpg" alt="floral 3"/></a>
                ...
                <div class="product_box no_margin_right">
                    <a href="product_detail.ftl"><img src="/rs/images/product/04.jpg" alt="flowers 4"/></a>
                ...
                <div class="product_box">
                    <a href="product_detail.ftl"><img src="/rs/images/product/05.jpg" alt="floral set 5"/></a>
                ...
                <div class="product_box">
                    <a href="product_detail.ftl"><img src="/rs/images/product/07.jpg" alt="flowers 7"/></a>
                ...
                <div class="product_box">
                    <a href="product_detail.ftl"><img src="images/product/06.jpg" alt="flower set 6"/></a>
                ...
                <div class="product_box no_margin_right">
                    <a href="product_detail.ftl"><img src="images/product/08.jpg" alt="floral 8"/></a>
                ...
                <div class="blank_box">
                    <a href="#" class="button left">Предыдущая</a>
                    <a href="#" class="button right">Следующая</a>
                </div>
