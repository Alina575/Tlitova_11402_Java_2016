            ...
            <div id="content" class="right">
                ...
                <form method="post" action="/shopping_cart">
                    ...
                    <table width="700" border="0" cellpadding="5" cellspacing="0">
                        <tr bgcolor="#395015">
                            <th width="168" align="left">Товар</th>
                            <th width="188" align="left">Название</th>
                            <th width="60" align="center">Количество</th>
                            <th width="80" align="right">Цена, руб</th>
                            <th width="80" align="right">Общее, руб</th>
                            <th width="64"></th>
                        </tr>
                        <tr bgcolor="#41581B">
                            <td><img src="/rs/images/product/01.jpg" alt="flower"/></td>
                            <td>Роза</td>
                            <td align="center"><input name="quantity" type="text" value="1" size="6" maxlength="2"/>
                            </td>
                            <td align="right">240</td>
                            <td align="right">240</td>
                            <td align="center"><a href="/item_delete?q=${f.id}"><img src="/rs/images/remove.png"
                                                                                     alt="remove"/><br/>Удалить</a></td>
                        </tr>
                        <tr bgcolor="#41581B">
                            <td><img src="/rs/images/product/02.jpg" alt="flower image 2"/></td>
                            <td>Тюльпан</td>
                            <td align="center"><input name="quantity" type="text" value="2" size="6" maxlength="2"/>
                            </td>
                        ...
                        <tr bgcolor="#41581B">
                            ...
                            <td align="right"></td>
                            <td align="right"></td>
                            <td align="right" width="100"><h4>Сумма, руб:</h4></td>
                            <td align="center"><h4>560</h4></td>
                            <td></td>
                        </tr>
                    </table>
                    <div class="cleaner h20"></div>
                    <div class="right"><input class="login" type="submit" value="Заказать"/></div>
                    <div class="cleaner h20"></div>
